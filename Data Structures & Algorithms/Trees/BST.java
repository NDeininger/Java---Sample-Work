...
public class BST<E extends Comparable<E>> implements Tree<E> {
    ...
    private boolean isEqualTo(TreeNode<?> root1, TreeNode<?> root2) {
        ...
        if (root1.left == null || root2.left == null) {
            leftMatch = root1.left == root2.left; // base case
        } else {
            leftMatch = isEqualTo(root1.left, root2.left); // recursive call
        }
        // check right side
        boolean rightMatch;
        if (root1.right == null || root2.right == null) {
            rightMatch = root1.right == root2.right; // base case
        } else {
            rightMatch = isEqualTo(root1.right, root2.right); // recursive call
        }
