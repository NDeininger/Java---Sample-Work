...
Description: This program implements an in place heap sort algorithm. Instead of using heap objects,
             this implementation conducts the heap sort using just the array of numbers that is provided.
             As a result, very little additional memory is used. This implementation is intended to be compared
             to the performance of an insertion sort and a normal heap sort.
 */
