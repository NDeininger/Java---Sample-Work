...
public class TripTester {
	...
	public static void main(String[] args) {
		...
		userPrompt();
		RoundTripPlannerSoln roundTripPlanner = new RoundTripPlannerSoln(cities, connections, startCityIndex, endCityIndex);
	...
	private static void verifyRoundTrip(RoundTripPlannerSoln roundTripPlanner) {
